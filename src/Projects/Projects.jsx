...
const Projects = ({setSelected}) => {
  ...
  return (
    ...
    ref={ref}
      id="project"
      className="relative px-3 flex flex-col items-center justify-evenly min-h-screen py-20 w-full bg-black"
    >
      <span className=" popUpAnimation heading font-bold text-5xl top-16 inline-block">
        My Projects
      </span>
